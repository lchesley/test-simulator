...
namespace TestSimulator
{
    public class Craft : ICraft
    {
        ...
        public void SetInitialValues(int itemLevel, int durability, int difficulty, int itemQuality, string itemName)
        {
        ...
        public void SetInitialValues(int itemLevel, int durability, int difficulty, int itemQuality, string itemName, ElementalAffinity affinity)
        {
            this.itemLevel = itemLevel;
            this.baseItemLevel = itemLevel;
            this.durability = durability;
